...
public class ParameterDao_ extends BaseDao {

	private static Logger logger = Logger.getLogger(ParameterDao_.class);

	public ParameterDao_() throws ExceptionCommonBase {
		super("cloud");
	}
	...
	public static void main(String[] args) {
		Utils.initLog4j();
		ParameterDao_ dao = null;
		Connection conn = null;
		try {
			dao = new ParameterDao_();
			...
			new ParameterDao_().insertParameterTagLinkInfo(conn,
